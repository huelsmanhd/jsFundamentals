...
var netflix = {
    ...
    let show = netflix.season1.seasonInfo.episodeInfo[8].episodeName;
    console.log(`The best episode from season one is ${show}`); //string interpolation
    console.log('My favorite episode is', netflix.season1.seasonInfo.episodeInfo[5].episodeName); //string concatenation

    let sea1 = Object.keys(netflix)
    console.log(sea1[2]) //object key:value
...
console.log(garden.vegetable) // Object Notation
...
let baking = {}
baking['zucchini'] = 'Lets make some bread';
